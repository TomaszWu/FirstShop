            ...
            <div id="myCarousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    ...
                    <div class="item active">
                        <a href="showCategory.php?id=1"><img src="/FirstShop/Pictures/30/30_4.jpg" alt="Chania" width="460" height="345"></a>
                    ...
                    <div class="item">
                        <a href="showCategory.php?id=1"><<img src="/FirstShop/Pictures/32/32.jpg" alt="Chania" width="460" height="345"></a>
                        <div class="carousel-caption">
                            <h3>Samochody</h3>
                            <p>The atmosphere in Chania has a touch of Florence and Venice.</p>
                        </div>
                    ...
                    <div class="item">
                        <a href="showCategory.php?id=1"><<img src="/FirstShop/Pictures/31/31.jpg" alt="Flower" width="460" height="345"></a>
                        <div class="carousel-caption">
                            <h3>Samochody</h3>
                    ...
                    <div class="item">
                        <a href="showCategory.php?id=1"><<img src="/FirstShop/Pictures/33/33_1.jpg" alt="Flower" width="460" height="345"></a>
                        <div class="carousel-caption">
                            <h3>Samochody</h3>
                            <p>Beatiful flowers in Kolymbari, Crete.</p>
                        </div>
